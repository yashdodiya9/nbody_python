...
void nbody_main(const char* input_file) {
...
void run_nbody_simulation(const char* input_file) {
    nbody_main(input_file);
}

                
//////HAS CHANGED WHOLE FILE WITH NECESSARY CHANGES AS PER CHATPGT//////